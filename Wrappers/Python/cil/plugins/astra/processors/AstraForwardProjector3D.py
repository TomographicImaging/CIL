...
from cil.framework import DataProcessor, AcquisitionData, ImageDimensionLabels, AcquisitionDimensionLabels
...
class AstraForwardProjector3D(DataProcessor):
    ...
    def set_ImageGeometry(self, volume_geometry):
        ...
        ImageDimensionLabels.check_order_for_engine('astra', volume_geometry)
    ...
    def set_AcquisitionGeometry(self, sinogram_geometry):
        ...
        AcquisitionDimensionLabels.check_order_for_engine('astra', sinogram_geometry)
