...
#    numpy.testing.assert_equal(GD_C.dot_test(GD_C), True)
#    numpy.testing.assert_equal(GD_numpy.dot_test(GD_numpy), True)
#    print("Test passed\n")
#        
...
#    print("Test passed\n")
#    
#    print("Test Gradient for 2D Geometry passed\n")
#    
#    ###########################################################################
#    ###########################################################################
#    ###########################################################################
...
#    ig = ImageGeometry(100,100,100, voxel_size_x=0.1, voxel_size_y=0.5, voxel_size_z = 0.4)  
#    x = ig.allocate('random')
#    
#    GD_C = Gradient(ig, backend = 'c')
#    GD_numpy = Gradient_numpy(ig, backend = 'numpy')
...
#    print("Test passed\n")
#    
#    print("Test Gradient for 3D Geometry passed\n")
#
############################################################################
#    ###########################################################################
#    ###########################################################################
...
#    ig = ImageGeometry(100,100, voxel_size_x=0.1, voxel_size_y=0.5, channels = 100)  
#    x = ig.allocate('random')
#    
#    GD_C = Gradient(ig, backend = 'c')
#    GD_numpy = Gradient_numpy(ig, backend = 'numpy')
...
#    
#    print("Check dot test")
#    numpy.testing.assert_approx_equal(GD_C.dot_test(GD_C), True, significant = 1)
#    numpy.testing.assert_approx_equal(GD_numpy.dot_test(GD_numpy), True, significant = 1)
#    print("Test passed\n")
#        
#    print("Check dot test for Gradient Numpy with different method/bdn_cond")
#        
...
#    
#    
##    tmp = Gradient_numpy(ig)
##
##    # res = tmp.direct(x)
##
##    print(tmp.norm())
##    print(np.sqrt(8/ig.voxel_size_x**2))
##
##    res = tmp.range_geometry().allocate()
##    for i in range(2):
##        FiniteDiff(ig, direction=i).direct(x, out = res[i])
##        print(res[i].as_array())
#
#
#
#    # res = tmp.range_geometry().allocate()
...
#
#    # FiniteDiff(ig).direct(x, out = res)
#    # print(res.as_array())
#
#    # print(np.sqrt(8/ig.voxel_size_x**2))
#    # print(tmp.norm())
#    
#    
#    # ig = ImageGeometry(300, 400, voxel_size_x=0.3, voxel_size_y=0.3)
#    # # ig = ImageGeometry(300, 400)
#    # x = ig.allocate('random')
#    
...
#
#
#    # G_numpy = Gradient_numpy(ig, method = 'forward', bnd_cond = 'Neumann')  
#    # print(G_numpy.norm()) 
#    # import numpy as np
#    # print(np.sqrt(8/ig.voxel_size_x))     
#
#    # Gtmp = Gradient(ig, method = 'forward', bnd_cond = 'Periodic')  
#    # print(Gtmp.norm()) 
#    # import numpy as np
#    # print(np.sqrt(8/ig.voxel_size_x))        
#
