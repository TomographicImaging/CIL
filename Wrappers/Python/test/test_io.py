...
log.info("has_astra {}".format(has_astra))
log.info("has_wget {}".format(has_wget))
log.info("has_olefile {}".format(has_olefile))
log.info("has_dxchange {}".format(has_dxchange))
log.info("has_file {}".format(has_file))

if not has_file:
    log.info("This unittest requires the walnut Zeiss dataset saved in {}".format(data_dir))
