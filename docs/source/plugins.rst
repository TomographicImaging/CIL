...
Note that we provide this wrapper for the convenience of our users who use Tigre or want a specific algorithm and have tested the CIL side of converting the geometries and passing to Tigre. However, we do not provide support for the algorithms themselves or guarantee that they will work as expected. Please refer to the TIGRE documentation for details on the algorithms and their parameters.

.. autoclass:: cil.plugins.tigre.tigre_algo_wrapper
   :members:
   :inherited-members:
