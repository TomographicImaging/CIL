...
find_library(IPP_CORE ${IPP_PRE}ippcore${IPP_POST} PATHS ${IPP_ROOT_DIR} $ENV{CONDA_PREFIX} PATH_SUFFIXES Library/lib)
find_library(IPP_S ${IPP_PRE}ipps${IPP_POST} PATHS ${IPP_ROOT_DIR} $ENV{CONDA_PREFIX} PATH_SUFFIXES Library/lib)
find_library(IPP_VM ${IPP_PRE}ippvm${IPP_POST} PATHS ${IPP_ROOT_DIR} $ENV{CONDA_PREFIX} PATH_SUFFIXES Library/lib)
find_library(IPP_I ${IPP_PRE}ippi${IPP_POST} PATHS ${IPP_ROOT_DIR} $ENV{CONDA_PREFIX} PATH_SUFFIXES Library/lib)
