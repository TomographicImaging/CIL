...
class FunctionOfAbs(Function):
    ...
    where
    :math:`z = r \circ Phi`, :math:`r = abs(z)`, :math`:\Phi = \exp(i angl(z)):,
    and :math:`\circ` is element-wise product.  Also define :math:`prox^+` to be the proximal map of :math:`H` 
    ...
    def convex_conjugate(self, x):
        ...
        if self._lower_semi:
            ...
            raise NotImplementedError('Convex conjugate not available for this function. If you are sure your function is lower semi-continuous, convex, non-decreasing and finite at the origin, set assume_lower_semi=True')
