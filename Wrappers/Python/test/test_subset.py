...
class TestSubset(unittest.TestCase):
    ...
    def test_ImageDataAllocate1a(self):
        ...
        default_dimension_labels = [ImageDimensionLabels["CHANNEL"], ImageDimensionLabels["VERTICAL"],
    ...
    def test_ImageDataAllocate2a(self):
        non_default_dimension_labels = [ ImageDimensionLabels["HORIZONTAL_X"], ImageDimensionLabels["VERTICAL"],
                ImageDimensionLabels["HORIZONTAL_Y"], ImageDimensionLabels["CHANNEL"]]
    ...
    def test_ImageDataSubset1a(self):
        non_default_dimension_labels = [ImageDimensionLabels["HORIZONTAL_X"], ImageDimensionLabels["CHANNEL"], ImageDimensionLabels["HORIZONTAL_Y"],
    ...
    def test_ImageDataSubset5a(self):
        non_default_dimension_labels = [ImageDimensionLabels["HORIZONTAL_X"], ImageDimensionLabels["HORIZONTAL_Y"]]
        self.ig.set_labels(non_default_dimension_labels)
        data = self.ig.allocate()
        sub = data.get_slice(horizontal_y = 1)
    ...
    def test_ImageDataSubset1b(self):
        ...
        self.ig.set_labels(non_default_dimension_labels)
        data = self.ig.allocate()
        new_dimension_labels = [ImageDimensionLabels["HORIZONTAL_Y"], ImageDimensionLabels["CHANNEL"], ImageDimensionLabels["VERTICAL"], ImageDimensionLabels["HORIZONTAL_X"]]
    ...
    def test_AcquisitionDataAllocate1a(self):
        ...
        default_dimension_labels = [AcquisitionDimensionLabels["CHANNEL"] ,
    ...
    def test_AcquisitionDataAllocate2a(self):
        non_default_dimension_labels = [AcquisitionDimensionLabels["CHANNEL"], AcquisitionDimensionLabels["HORIZONTAL"],
         AcquisitionDimensionLabels["VERTICAL"], AcquisitionDimensionLabels["ANGLE"]]
