...
FD.fdiff4D.argtypes = [ctypes.POINTER(ctypes.c_float),
...
FD.fdiff4D(arr_p, out_dx_p, out_dy_p, out_dz_p, out_dc_p, nx, ny, nz, nc, 0, 1)
t0 = time.time()
for i in range(niters):
    FD.fdiff4D(arr_p, out_dx_p, out_dy_p, out_dz_p, out_dc_p, nx, ny, nz, nc, 0, 1)
...
FD.fdiff4D(adjoint_out_p, out_dx_p, out_dy_p, out_dz_p, out_dc_p, nx, ny, nz, nc, 0, 0)
t0 = time.time()
for i in range(niters):
    FD.fdiff4D(adjoint_out_p, out_dx_p, out_dy_p, out_dz_p, out_dc_p, nx, ny, nz, nc, 0, 0)
...
FD.fdiff4D(arr_p, out_dx_p, out_dy_p, out_dz_p, out_dc_p, nx, ny, nz, nc, 1, 1)
t0 = time.time()
for i in range(niters):
    FD.fdiff4D(arr_p, out_dx_p, out_dy_p, out_dz_p, out_dc_p, nx, ny, nz, nc, 1, 1)
...
FD.fdiff4D(adjoint_out_p, out_dx_p, out_dy_p, out_dz_p, out_dc_p, nx, ny, nz, nc, 1, 0)
t0 = time.time()
for i in range(niters):
    FD.fdiff4D(adjoint_out_p, out_dx_p, out_dy_p, out_dz_p, out_dc_p, nx, ny, nz, nc, 1, 0)
