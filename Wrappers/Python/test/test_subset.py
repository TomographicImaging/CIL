...
import numpy
from cil.framework import DataContainer, ImageGeometry, AcquisitionGeometry, DimensionLabelsImage, DimensionLabelsAcquisition
...
class TestSubset(unittest.TestCase):
    ...
    def test_ImageDataAllocate1a(self):
        ...
        default_dimension_labels = [DimensionLabelsImage["CHANNEL"], DimensionLabelsImage["VERTICAL"],
    ...
    def test_ImageDataAllocate2a(self):
        non_default_dimension_labels = [ DimensionLabelsImage["HORIZONTAL_X"], DimensionLabelsImage["VERTICAL"],
                DimensionLabelsImage["HORIZONTAL_Y"], DimensionLabelsImage["CHANNEL"]]
    ...
    def test_ImageDataSubset1a(self):
        non_default_dimension_labels = [DimensionLabelsImage["HORIZONTAL_X"], DimensionLabelsImage["CHANNEL"], DimensionLabelsImage["HORIZONTAL_Y"],
    ...
    def test_ImageDataSubset5a(self):
        non_default_dimension_labels = [DimensionLabelsImage["HORIZONTAL_X"], DimensionLabelsImage["HORIZONTAL_Y"]]
        self.ig.set_labels(non_default_dimension_labels)
        data = self.ig.allocate()
        sub = data.get_slice(horizontal_y = 1)
    ...
    def test_ImageDataSubset1b(self):
        ...
        self.ig.set_labels(non_default_dimension_labels)
        data = self.ig.allocate()
        new_dimension_labels = [DimensionLabelsImage["HORIZONTAL_Y"], DimensionLabelsImage["CHANNEL"], DimensionLabelsImage["VERTICAL"], DimensionLabelsImage["HORIZONTAL_X"]]
    ...
    def test_AcquisitionDataAllocate1a(self):
        ...
        default_dimension_labels = [DimensionLabelsAcquisition["CHANNEL"] ,
    ...
    def test_AcquisitionDataAllocate2a(self):
        non_default_dimension_labels = [DimensionLabelsAcquisition["CHANNEL"], DimensionLabelsAcquisition["HORIZONTAL"],
         DimensionLabelsAcquisition["VERTICAL"], DimensionLabelsAcquisition["ANGLE"]]
