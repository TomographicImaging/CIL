...
> [!NOTE]
> When pushing to `master` or creating an [annotated tag](https://git-scm.com/book/en/v2/Git-Basics-Tagging), *all* variants are built and tested. To run these tests on a push to a PR, include `#all-tests` in your commit message. 
