...
# the following comes directly from https://github.com/scikit-image/scikit-image/blob/master/skimage/util/noise.py
# it's copied here for incompatibility of other parts of skimage with Numpy 1.11
