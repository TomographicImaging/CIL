...
class SymmetrizedGradient(Gradient):
    ...
    def __init__(self, gm_domain, bnd_cond = 'Neumann', **kwargs):
        ...
        super(SymmetrizedGradient, self).__init__(gm_domain.get_item(0), bnd_cond, **kwargs) 
                
        self.gm_domain = gm_domain #self.gm_range 
...
if __name__ == '__main__':   
    ...
    E1 = SymmetrizedGradient(Grad1.range_geometry(), correlation = 'Space', bnd_cond='Neumann')
    
    try:
        E1 = SymmetrizedGradient(Grad1.range_geometry(), correlation = 'SpaceChannels', bnd_cond='Neumann')
    except:
        print("No Channels to correlate")
#        
    E2 = SymmetrizedGradient(Grad2.range_geometry(), correlation = 'SpaceChannels', bnd_cond='Neumann')  
#
